...
public class TeacherQuestionList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_question_list);
        questions = new ArrayList<>();
        HttpUtil.sendHttpRequest("GetAllQuestion?", new HttpCallbackListener() {
            @Override
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            holder.view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    QuestionFragment myDialogFragment = new QuestionFragment();
